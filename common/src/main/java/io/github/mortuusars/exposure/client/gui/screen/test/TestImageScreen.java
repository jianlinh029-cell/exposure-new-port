...
public class TestImageScreen extends Screen {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        ExposureClient.photographRenderer().renderImageInGui(guiGraphics, renderableImage,
                0, 0, Mth.floor(size), Mth.floor(size), 255, 255, 255, 255);
    ...
    public boolean mouseDragged(MouseButtonEvent mouseButtonEvent, double dragX, double dragY) {
        ...
        if (mouseButtonEvent.button() != InputConstants.MOUSE_BUTTON_RIGHT) return false;
