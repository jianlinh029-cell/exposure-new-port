...
public class ComponentTransferringRecipeSerializer<T extends ComponentTransferringRecipe> implements RecipeSerializer<T> {
                                        ...
                                        list -> {
                                            if (list.isEmpty()) {
                                                ...
                                                return list.size() > 9
                                                        ...
                                                        : DataResult.success(createNonEmptyList(list));
                                            }
                                        },
                                        DataResult::success
                                )
    ...
    private static @NotNull NonNullList<Ingredient> createNonEmptyList(List<Ingredient> list) {
        NonNullList<Ingredient> nonNullList = NonNullList.createWithCapacity(list.size());
