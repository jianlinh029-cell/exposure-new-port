...
## 1.9.60 - Minecraft 1.21.11 Fabric Port (Final)
- Final release of the Minecraft 1.21.11 Fabric port.
- Original Exposure mod by **mortuusars**.
- Ported to Minecraft 1.21.11 (Fabric) by **Suiyun** (Port Author).
- Original author's copyright and the MIT License are retained unchanged.
- Metadata/release version only; no gameplay or rendering changes over 1.9.59.
