...
- **Original Author:** mortuusars
  - Upstream project: [CurseForge](https://curseforge.com/minecraft/mc-mods/exposure) · [Modrinth](https://modrinth.com/mod/exposure) · [GitHub](https://github.com/mortuusars/Exposure)
- **Port Author (Minecraft 1.21.11 / Fabric):** Suiyun
  - Original Exposure mod by mortuusars. Ported to Minecraft 1.21.11 (Fabric) by Suiyun.
  - The original author's copyright and the MIT License are retained unchanged.
